...
package org.groovykoans.koan11_db
...
class Koan11 extends GroovyTestCase {
    ...
    void test02_MoreOnInsertingData() {
        ...
        Sql.withInstance('jdbc:h2:mem:groovyDb2', 'sa', '', 'org.h2.Driver') { db ->
            ...
            // ------------ START EDITING HERE ----------------------
            new File('src/test/groovy/org/groovykoans/koan11_db/cast.txt').eachLine { line ->
            ...
            // ------------ START EDITING HERE ----------------------
            def xml = new XmlSlurper().parse('src/test/groovy/org/groovykoans/koan11_db/cast2.xml')
    ...
    void initDb(Sql db) {
        def baseDir = 'src/test/groovy/org/groovykoans/koan11_db'
