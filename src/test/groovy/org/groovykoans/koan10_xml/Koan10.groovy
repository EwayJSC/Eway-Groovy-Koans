...
package org.groovykoans.koan10_xml
...
class Koan10 extends GroovyTestCase {
    ...
    void test01_XmlSlurpersReader() {
        ...
        def movieCount
        // ------------ START EDITING HERE ----------------------
        def xml = new XmlSlurper().parse('src/test/groovy/org/groovykoans/koan10_xml/movies.xml')
        ...
        // ------------ START EDITING HERE ----------------------
        def xml2 = new XmlSlurper().parse('src/test/groovy/org/groovykoans/koan10_xml/movies.xml')
        ...
        // ------------ START EDITING HERE ----------------------
        def xml3 = new XmlSlurper().parse('src/test/groovy/org/groovykoans/koan10_xml/movies.xml')
    ...
    void test04_XmlMarkupBuilder2() {
        ...
        String convertedXml
        // ------------ START EDITING HERE ----------------------
        def reader = new XmlSlurper().parse('src/test/groovy/org/groovykoans/koan10_xml/movies.xml')
        def writer = new StringWriter()
    ...
    void test05_AntBuilderCopy() {
        ...
        // http://ant.apache.org/manual/Tasks/copy.html
        def baseDir = 'src/test/groovy/org/groovykoans/koan10_xml'
        // ------------ START EDITING HERE ----------------------
